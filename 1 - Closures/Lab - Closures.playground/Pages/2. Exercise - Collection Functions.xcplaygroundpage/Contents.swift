...
let names : [String] = ["tiya", "simran", "yashika", "saurabh"]

let sortedCollection = names.sorted(by: forwards)
print("Sorted names: ", sortedCollection)
...
let sortedColl = names.sorted(by: {(name1: String, name2: String) -> Bool in
        return name1 < name2
})

print("Sorted names (using Closure):", sortedColl)
...
let sortedCol = names.sorted(by: {$0 < $1})
print("Sorted (short): " , sortedCol)
